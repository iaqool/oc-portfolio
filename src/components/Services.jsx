    ...
    const servicesData = [
        {
            ...
            desc: "Создание полноценных автономных ИИ-офисов и автоматизация процессов Lead Gen для взрывного роста. Автоматизируем рутинную работу, берем на себя анализ огромных массивов данных и кардинально оптимизируем расходы вашей компании на персонал и маркетинг.",
            icon: (
